...
final class Registry
{
    ...
    public function __construct(private readonly Db $db, private readonly Hooks $hooks)
    {
        foreach ([
            ...
            Sms\VonageProvider::class,
            Sms\MessageBirdProvider::class,
            Sms\PlivoProvider::class,
            Sms\SinchProvider::class,
            Sms\TelnyxProvider::class,
            Sms\SnsProvider::class,
            Sms\ClickSendProvider::class,
            Sms\TextlocalProvider::class,
            Sms\BulkSmsProvider::class,
            Sms\WebhookProvider::class,
